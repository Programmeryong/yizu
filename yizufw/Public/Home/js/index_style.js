...
$(function () {
    ...
    $(".login .checkb").click(function () {
        ...
        if (dian % 2 == 1) {
            $(this).css({
                "background": "url(/public/home/images/icon/checkbox-checked-o.png) 1px 11px no-repeat",
            ...
            $(this).css({
                "background": "url(/public/home/images/icon/checkbox-o.png) 0px 9px no-repeat",
    ...
    $(".coupon_img img").click(function () {
        $(".rightclick1").click();
        $("#nav_right li:first-child").click();
        $(".coupon").hide();
    });
    $(".close_coupon i").click(function () {
        $(".temp").css({"visibility": "hidden"});
        $(".coupon").hide();
    });
    /*优惠券结束*/
    ...
    $(".login input[type='tel']").click(function () {
