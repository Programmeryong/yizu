$(function () {
    ...
    $(".metro_lable").click(function () {
        i++;
        if (i % 2 == 1) {
            $(this).css({"background": "#FFB319", "color": "#fff"});
            sum++;
        } else {
            $(this).css({"background": "#FFF7E6", "color": "#FFB319"});
            sum--;
        }
        $(".label_sum").html(sum);
    })
    ...
    $(".less_lable").click(function () {
        i1++;
        if (i1 % 2 == 1) {
            $(this).css({"background": "#F52230", "color": "#fff"});
            sum++;
        } else {
            $(this).css({"background": "#FFEBEC", "color": "#F52230"});
            sum--;
        }
        $(".label_sum").html(sum);
    })
    ...
    $(".worked_jiaju").click(function () {
        i2++;
        if (i2 % 2 == 1) {
            $(this).css({"background": "#52C41A", "color": "#fff"});
            sum++;
        } else {
            $(this).css({"background": "#F5FFEB", "color": "#52C41A"});
            sum--;
        }
        $(".label_sum").html(sum);
    })
    ...
    $(".property").click(function () {
        i3++;
        if (i3 % 2 == 1) {
            $(this).css({"background": "#2D96FF", "color": "#fff"});
            sum++;
        } else {
            $(this).css({"background": "#EBF5FF", "color": "#198CFF"});
            sum--;
        }
        $(".label_sum").html(sum);
    })
    ...
    /*推荐用户*/
    $(".rcdcmn_once").click(function () {
        $(".rcdcmn_box").css({"display": "block"});
        $(".temp").css({"visibility": "visible"});//添加一层膜
    })
    $(".close_rcdcmn_box").click(function () {
