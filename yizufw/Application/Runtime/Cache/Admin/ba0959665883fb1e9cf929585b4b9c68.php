    ...
    <div id="panel" lay-filter="panel">
        <div class="layui-form">
            <table class="layui-table">
                ...
                <tbody id="x-img">
                <?php if(is_array($entrust_list)): $i = 0; $__LIST__ = $entrust_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td class="td-manage">
                            <?php if(($vo["status"]) == "1"): ?><a class="layui-btn layui-btn-small"
                                ...
                                <a class="layui-btn layui-btn-small"
                                   ...
                                   href="javascript:void(0);" onclick="x_admin_show('要求详情','<?php echo U('Entrust/read');?>'+'?id='+<?php echo ($vo["id"]); ?>, 500,200)">
                                    要求详情</a>
                                <?php else: ?>
                                <a class="layui-btn layui-btn-small"
                                   style="line-height:1.6em;margin-top:3px;padding-top: 6px"
                                   ...
                                   onclick="member_stop(this,'<?php echo ($vo["id"]); ?>','<?php echo (session('admin_id')); ?>');">
                                    联系用户并填写要求和更改状态</a>
                                <a class="layui-btn layui-btn-small layui-hide"
                                   style="line-height:1.6em;margin-top:3px;padding-top: 6px;"
                                   href="javascript:void(0);" onclick="x_admin_show('要求详情','<?php echo U('Entrust/read');?>'+'?id='+<?php echo ($vo["id"]); ?>, 500,200)">
                                    要求详情</a><?php endif; ?>
                        </td>
...
<script>
    ...
    function member_stop(obj, id, admin_id) {
        layer.prompt({
            ...
            //发异步把用户状态进行更改
            $.post("<?php echo U('Entrust/setStatus');?>", {
                id: id,
                require: value,
                admin_id: admin_id
            }, function (res) {
                if (res == 200) {
                    ...
                    $(obj).next().removeClass('layui-hide');
