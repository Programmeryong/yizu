    ...
    <form class="layui-form" method="post" id="add_article_type" enctype="multipart/form-data">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                ...
                <div class="layui-hide" id="type-id"><?php echo ($news["news_type_id"]); ?></div>
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">
            ...
            <div class="layui-input-block">
                <img class="layui-upload-img" id="preview"
                     style="width: 424px;height: 235px; border: 1px dashed #cccccc" src="<?php echo ($news["img_url"]); ?>">
            </div>
            <input type="hidden" name="img_url" id="img_url" value="<?php echo ($news["img_url"]); ?>"/>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">
            </label>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="news_title" required lay-verify="news_title" autocomplete="off"
                       class="layui-input"
                       id="news_title" value="<?php echo ($news["news_title"]); ?>">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">
            ...
            <div class="layui-input-block">
                <input type="text" name="keyword" required lay-verify="keyword" autocomplete="off" class="layui-input"
                       id="keyword" value="<?php echo ($news["keyword"]); ?>">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">
            ...
            <div class="layui-input-block">
                <input type="text" name="describe" required lay-verify="describe" autocomplete="off" class="layui-input"
                       id="describe" value="<?php echo ($news["describe"]); ?>">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">
            ...
            <div class="layui-hide" id="hide_content"><?php echo ($news["new_text"]); ?></div>
        </div>
        <input id="id" value="<?php echo ($news["id"]); ?>" type="hidden">
        <input id="author_id" value="<?php echo ($news["author_id"]); ?>" type="hidden">
        <div class="layui-form-item">
            <label class="layui-form-label">
            </label>
...
<script>
    layui.use(['form', 'layer', 'upload'], function () {
        ...
        let content = $('#hide_content').html();
        editor.setValue(content);

        let type = $('#type-id').text();
        $('#type').val(type);
        form.render('select', 'type-div');
        ...
        form.on('submit(add)', function () {
            ...
            if (content != '') {
                ...
                $.post("<?php echo U('News/update');?>", {
                    ...
                    if (res == 200) {
                        layer.alert("修改成功，请刷新查看", {icon: 1}, function () {
                            // 获得frame索引
