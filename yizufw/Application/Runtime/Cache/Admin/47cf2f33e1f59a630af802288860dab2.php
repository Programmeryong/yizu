    ...
    <div id="panel" lay-filter="panel">
        <div class="layui-form">
            <table class="layui-table">
                ...
                <tbody id="x-img">
                <?php if(is_array($banner_list)): $i = 0; $__LIST__ = $banner_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        <td>
                        ...
                        <td>
                            <img class="layui-upload-img table-img" id="preview" src='<?php echo ($vo["img_src"]); ?>'>
                        </td>
