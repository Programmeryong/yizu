...
<head>
    <meta charset="UTF-8">
    <title>新闻资讯</title>
    <link rel="shortcut icon" href="./images/yz.ico">
                    ...
                    <li class="dropdown righthis">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                           aria-expanded="false" style="padding-bottom: 5px;">
                            <img src="/Public/Home/images/head/minhead.jpeg">
                        </a>
                        <ul id="nav_mintext" class="dropdown-menu nav_mintext">
                            <li><a href="<?php echo (session('user_id')); ?>">消息</a></li>
                            <li><a href="<?php echo (session('user_id')); ?>">账号设置</a></li>
            ...
            success: function (res) {
                if (res.status == 1) {
                    ...
                    $('#nav_rightbtn_li').before(
                        ...
                        "<li><a href=\"" + res.user_id + "\">账号设置</a></li>" +
                        "<li><a href=\"" + res.user_id + "\">个人中心</a></li>" +
